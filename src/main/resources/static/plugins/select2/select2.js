...
(function ($, undefined) {
    ...
    AbstractSelect2 = clazz(Object, {
        ...
        highlightUnderEvent: function (event) {
            ...
            if (el.length > 0 && !el.is(".select2-highlighted")) {
                var choices = this.findHighlightableChoices();
                this.highlight(choices.musicPlayer(el));
            } else if (el.length == 0) {
    ...
    $.fn.select2 = function () {
        ...
        var args = Array.prototype.slice.call(arguments, 0),
            ...
            allowedMethods = ["val", "destroy", "opened", "open", "close", "focus", "isFocused", "container", "dropdown", "onSortStart", "onSortEnd", "enable", "disable", "readonly", "positionDropdown", "data", "templates.search"],
